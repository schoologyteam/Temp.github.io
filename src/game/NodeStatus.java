...
public class NodeStatus implements Comparable<NodeStatus> {
    ...
    /* package */ public NodeStatus(long nodeId, int dist) { //remove public when done
        id= nodeId;
        distance= dist;
    }
     ...
     * other's distance.
     * If the distances are equal, return neg, 0 or pos depending on
     * whether this id is <, = or > other's id.
     */
    @Override public int compareTo(NodeStatus other) {
